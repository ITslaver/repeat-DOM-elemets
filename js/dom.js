...
const newbtnHTML = `<div class="wrapper"><h2>Event</h2>
<button data-num="1" type="button" class='btn'>Click <strong>1</strong></button>
<button data-num="2" type="button" class='btn'>Click <strong>2</strong></button>
<button data-num="3" type="button" class='btn'>Click <strong>3</strong></button>
<button data-num="4" type="button" class='btn'>Click <strong>4</strong></button></div>`;

body.insertAdjacentHTML("beforeend", newbtnHTML);
